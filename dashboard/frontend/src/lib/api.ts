...
export const createTask = (data: { prompt: string; repo: string; base_branch?: string; image_url?: string }) =>
...
export const sendTaskMessage = (id: string, content: string, image_url?: string) =>
